...
public class LoserBanner {
    JFrame frame;
    GameFrame gameFrame;
    Clip musicClip;

    public LoserBanner(GameFrame gameFrame) {
    ...
    private void setupBackground() {
        ImageIcon backgroundIcon = new ImageIcon("images/Lose.png");
    ...
    private void setupButtons(JLabel backgroundLabel) {
        JButton mainMenuButton = createButton("", "images/MainMenu2.png", 120, 300, 170, 50);
        JButton playAgainButton = createButton("", "images/Play Again.png", 340, 300, 170, 50);
    ...
    private void playMusic() {
        try {
            File musicFile = new File("music/lose sound.wav");
